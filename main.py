...
if __name__ == "__main__":
    # Load the dataset
    dataset_path = "C:/Users/preks/OneDrive/Desktop/CA1/minimal_churn_data.csv"
    ...
    try:
        churn_rates = {
            "Month-to-Month": mtm_contract.calculate_churn_rate(),
            "One-Year": one_year_contract.calculate_churn_rate(),
            "Two-Year": two_year_contract.calculate_churn_rate()
        }
        print("Churn Rates:")
